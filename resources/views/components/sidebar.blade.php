    ...
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
        ...
        <div class="flex flex-shrink-0 transition-all">
            ...
            <nav aria-label="Options"
                ...
                <!-- User avatar button -->
                <div class="relative flex items-center flex-shrink-0 p-2 border-black border-2" x-data="{ isOpen: false }">
            ...
            <nav aria-label="Options"
                ...
                <!-- User avatar -->
                <div class="relative flex items-center flex-shrink-0 p-2 border-gray-400 border-2 rounded-lg" x-data="{ isOpen: false }">
                    <button @click="isOpen = !isOpen; $nextTick(() => {isOpen ? $refs.userMenu.focus() : null})"
                        class="transition-opacity rounded-lg opacity-80 hover:opacity-100 focus:outline-none focus:ring focus:ring-indigo-600 focus:ring-offset-white focus:ring-offset-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
