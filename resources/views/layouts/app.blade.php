            ...
            <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                ...
                <div class="flex flex-shrink-0 transition-all bg-[#116D6E]">
                    ...
                    <nav aria-label="Options"
                        class="fixed inset-x-0 bottom-0 flex flex-row-reverse items-center justify-between px-4 py-2 bg-white dark:bg-gray-800 border-t border-indigo-100 sm:hidden shadow-t rounded-t-3xl">
                        <!-- Menu button -->
                        <button
                    ...
                    <nav aria-label="Options"
                        ...
                        <div class="flex flex-col items-center flex-1 p-2 space-y-4">
                            <!-- Menu button -->
                            <button
                                onclick="window.location.href='{{ route('url.create') }}'"
